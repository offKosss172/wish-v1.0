...
class THWEPOF {
	...
	public function __construct() {
		...
		add_action('plugins_loaded', array($this,'thwepof_display_discount_announcement'));
	...
	public function thwepof_display_discount_announcement(){
		...
		$render_time  = apply_filters('thwepof_show_discount_popup_render_time', 6 * MONTH_IN_SECONDS);
